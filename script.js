let page = 1;
const page_text = {
    1: '<span class="heading">about me</span> internet user who has too much time on their hands! programmer, writer + reader, and artist once in a blue moon. fun fact, also tybalt capulet\'s strongest soldier. i run @bigmanbonnie on twt + bsky. i\'m quite busy outside of social media so apologies if i randomly go inactive!',
    ...
    3: '<span class="heading">literally me</span> adrian veidt (watchmen), egon spengler (ghostbusters), dwight (the walking dead comics), warren worthington iii (x-men), randy meeks (scream), green oak (pokemon adventures), and some i can\'t think of rn. i don\'t seriously kin, these are just characters who i think embody part of me in one way or another',
