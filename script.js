let page = 1;
const page_text = {
    1: '<span class="heading">about me</span> 15 yo. who has too much time on her hands! programmer, writer + reader, and artist once in a blue moon. fun fact, also tybalt capulet\'s strongest soldier. i run @bigmanbonnie on twt + bsky. i\'m quite busy outside of social media so apologies if i randomly go inactive!',
